...
const uk: Dictionary = {
  strings: {
    ...
    "about.updates": "Оновлення",
    "about.updateCheck": "Перевірити оновлення",
    "about.updateChecking": "Перевіряю…",
    "about.updateLatest": "У вас найновіша версія",
    "about.updateFound": "Доступна новіша версія:",
    "about.updateDownload": "Завантажити",
    "about.updateSaved": "Збережено в «Завантаження». Відкрийте образ і перетягніть Marswind у «Програми».",
    "about.updateShow": "Показати у Finder",
