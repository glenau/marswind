...
const fr: Dictionary = {
  strings: {
    ...
    "about.updateCheck": "Rechercher des mises à jour",
    "about.updateChecking": "Recherche…",
    "about.updateLatest": "Vous avez la dernière version",
    "about.updateFound": "Une version plus récente existe :",
    "about.updateDownload": "Télécharger",
    "about.updateSaved": "Enregistré dans Téléchargements. Ouvrez-le et glissez Marswind dans Applications.",
    "about.updateShow": "Afficher dans le Finder",
