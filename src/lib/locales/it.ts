...
const it: Dictionary = {
  strings: {
    ...
    "about.updateCheck": "Cerca aggiornamenti",
    "about.updateChecking": "Controllo…",
    "about.updateLatest": "Hai l'ultima versione",
    "about.updateFound": "È disponibile una versione più recente:",
    "about.updateDownload": "Scarica",
    "about.updateSaved": "Salvato in Download. Aprilo e trascina Marswind in Applicazioni.",
    "about.updateShow": "Mostra nel Finder",
