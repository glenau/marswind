...
const ru: Dictionary = {
  strings: {
    ...
    "about.updateCheck": "Проверить обновления",
    "about.updateChecking": "Проверяю…",
    "about.updateLatest": "У вас последняя версия",
    "about.updateFound": "Доступна новая версия:",
    "about.updateDownload": "Скачать",
    "about.updateSaved": "Сохранено в «Загрузки». Откройте образ и перетащите Marswind в «Программы».",
    "about.updateShow": "Показать в Finder",
