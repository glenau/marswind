...
const es: Dictionary = {
  strings: {
    ...
    "about.updateCheck": "Buscar actualizaciones",
    "about.updateChecking": "Buscando…",
    "about.updateLatest": "Tienes la última versión",
    "about.updateFound": "Hay una versión más reciente:",
    "about.updateDownload": "Descargar",
    "about.updateSaved": "Guardado en Descargas. Ábrelo y arrastra Marswind a Aplicaciones.",
    "about.updateShow": "Mostrar en Finder",
